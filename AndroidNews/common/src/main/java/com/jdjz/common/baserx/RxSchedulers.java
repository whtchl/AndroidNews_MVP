...
public abstract class RxSchedulers<T> extends Subscriber<T> {
    ...
    * */
    ...
    public RxSchedulers(Context context, String msg, boolean showDialogs) {
    ...
    public void onError(Throwable e) {
        ...
        e.printStackTrace();
        //网络
        if (!NetworkUtils.isNetConntected(BaseApplication.getAppContext())) {
    ...
    protected abstract void _onError(T t);
}
